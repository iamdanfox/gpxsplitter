...
var App, Blurb, Divider, DownloadLinks, EleView, FileInput, Footer, GPXView, HRLine, TinySummary, a, button, div, em, g, nicetime, p, path, rect, text, _ref;

_ref = React.DOM, div = _ref.div, p = _ref.p, a = _ref.a, button = _ref.button, rect = _ref.rect, path = _ref.path, g = _ref.g, text = _ref.text, em = _ref.em;
...
GPXView = React.createClass({
  ...
  render: function() {
    ...
    })), (this.props.cutoff == null ? React.DOM.p(null, "Click above to split your activity.") : void 0), (this.props.cutoff == null ? React.DOM.p(null, React.DOM.a({
      "href": '#',

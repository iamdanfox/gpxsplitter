...
var App, Divider, DownloadLinks, EleView, FileInput, GPXView, HRLine, TinySummary, a, button, div, form, g, h1, h2, input, nicetime, p, path, rect, span, svg, text, _ref;

_ref = React.DOM, div = _ref.div, form = _ref.form, input = _ref.input, p = _ref.p, h1 = _ref.h1, h2 = _ref.h2, a = _ref.a, button = _ref.button, svg = _ref.svg, rect = _ref.rect, path = _ref.path, g = _ref.g, span = _ref.span, text = _ref.text;

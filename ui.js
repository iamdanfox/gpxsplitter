...
var App, DownloadLinks, DownloadView, FileView, Selector, a, button, div, form, h1, input, p, _ref;

_ref = React.DOM, div = _ref.div, form = _ref.form, input = _ref.input, p = _ref.p, h1 = _ref.h1, a = _ref.a, button = _ref.button;
...
FileView = React.createClass({
  render: function() {
    ...
    return div({
      ...
      h1({}, name), p({}, start + " to " + end), Selector({
        start: start,
        end: end,

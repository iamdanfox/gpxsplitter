...
var App, Divider, DownloadLinks, EleView, GPXView, HRLine, a, button, div, form, g, h1, h2, input, p, path, rect, svg, _ref;

_ref = React.DOM, div = _ref.div, form = _ref.form, input = _ref.input, p = _ref.p, h1 = _ref.h1, h2 = _ref.h2, a = _ref.a, button = _ref.button, svg = _ref.svg, rect = _ref.rect, path = _ref.path, g = _ref.g;
...
App = React.createClass({
  ...
  render: function() {
    return div({
      ...
      })) : null, this.state.xml != null ? GPXView(this.state) : null, this.state.cutoff != null ? DownloadLinks(this.state) : null
    ]);
  }
});
